(function() {
    ...
    fetchReplacement = function(url) {
      ...
      xhr.onload = function() {
        ...
        if (assetsChanged(doc)) {
          return document.location.href = xhr.responseURL;
        } else {
    ...
    reflectRedirectedUrl = function(xhr) {
      var location;
      if ((location = xhr.getResponseHeader('X-XHR-Current-Location') || xhr.responseURL)) {
    ...
    ignoreClick = function(event, link) {
      return link.target || crossOriginLink(link) || anchoredLink(link) || nonHtmlLink(link) || noTurbolink(link) || nonStandardClick(event);
    };
